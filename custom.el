;; File dedicated to variables set via the Emacs customize facility.
;; Keep this file as small as possible and migrate stuff to main
;; init file inside `use-package` clauses.
